      ...
      <td colspan="2">
        <table>
          <tr>
            ...
            <%= (auth&Admin.AUTH_DMS)==0?"":"checked=\"true\"" %> />
            可以管理DMS账号</td>
            <td><input type="checkbox" name="dish"
            <%= (auth&Admin.AUTH_DISH)==0?"":"checked=\"true\"" %> />
            可以管理菜</td>
          </tr>
          <tr>
            <td><input type="checkbox" name="food"
            <%= (auth&Admin.AUTH_FOOD)==0?"":"checked=\"true\"" %> />
            可以管理食料</td>
            <td><input type="checkbox" name="nutriment"
            <%= (auth&Admin.AUTH_NUTRIMENT)==0?"":"checked=\"true\"" %> />
            可以管理营养素</td>
          </tr>
          <tr>
            <td><input type="checkbox" name="userGroup"
            <%= (auth&Admin.AUTH_USERGROUP)==0?"":"checked=\"true\"" %> />
            可以管理人群</td>
            <td><input type="checkbox" name="function"
            <%= (auth&Admin.AUTH_FUNCTION)==0?"":"checked=\"true\"" %> />
            可以管理功效</td>
          </tr>
          <tr>
            <td><input type="checkbox" name="unit"
            <%= (auth&Admin.AUTH_UNIT)==0?"":"checked=\"true\"" %> />
            可以管理度量单位</td>
            <td><input type="checkbox" name="user"
            <%= (auth&Admin.AUTH_USER)==0?"":"checked=\"true\"" %> />
            可以管理用户</td>
          </tr>
        </table>
      </td>
