...
<%@ page import="health.dishtype.DishTypeMan" %>
<%
...
<%
	if (needLogin) {
%>
    <p>您没有权限修改菜类别，正在跳转至首页，请稍候...</p>
<%
	} else {  
        DishType dishType = DishTypeMan.getDishType(id);
%>
    <table border="0">
    <tr>
    ...
    <form action="/changeDishType?id=<%= id %>" method="post">
    <table>
    <tr>
      <td>类别名</td>	
      <td><input type="text" name="name" value="<%= dishType.getName() %>" /></td> 
      <td>*不能为空</td>
    </tr>
    <tr>
