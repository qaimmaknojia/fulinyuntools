...
<%@ page import="health.cook.CookMan" %>
<%
...
<%
	if (needLogin) {
%>
    <p>您没有权限修改烹饪方式，正在跳转至首页，请稍候...</p>
<%
	} else {  
        Cook cook = CookMan.getCook(id);
%>
    <table border="0">
    <tr>
    ...
    <form action="/changeCook?id=<%= id %>" method="post">
    <table>
    <tr>
      <td>烹饪方式名</td>	
      <td><input type="text" name="name" value="<%= cook.getName() %>" /></td> 
      <td>*不能为空</td>
    </tr>
    <tr>
